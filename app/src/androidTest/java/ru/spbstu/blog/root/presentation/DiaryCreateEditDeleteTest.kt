...
class DiaryCreateEditDeleteTest {
    ...
    fun diaryCreateEditDeleteTest() {
        ...
        onView(withId(R.id.layout_notes__rv_posts))
            .check(ViewAssertions.matches(atPosition(0, hasDescendant(withText("Test")))))
        ...
        val appCompatEditText4 = onView(
            allOf(
                withId(R.id.frg_post__et_post), withText("Test"),
                childAtPosition(
                    childAtPosition(
                        withClassName(`is`("androidx.core.widget.NestedScrollView")),
                        0
        ...
        appCompatEditText4.perform(replaceText("Test new"))

        val appCompatEditText5 = onView(
            allOf(
                withId(R.id.frg_post__et_post), withText("Test new"),
                childAtPosition(
                    childAtPosition(
                        withClassName(`is`("androidx.core.widget.NestedScrollView")),
                        0
        ...
        viewGroup1.perform(object: ViewAction {
            override fun getConstraints(): Matcher<View> {
                return allOf(
                    isAssignableFrom(RecyclerView::class.java),
                    isDisplayed()
        ...
        viewGroup1.check(ViewAssertions.matches(atPosition(0, isDisplayed())))
        onView(isRoot()).perform(waitFor(1000))

        onView(withId(R.id.layout_notes__rv_posts))
            .check(ViewAssertions.matches(atPosition(0, hasDescendant(withText("Test new")))))
        ...
        onView(withId(R.id.layout_notes__rv_posts))
            .check(
                ViewAssertions.matches(
                    atPosition(
                        0,
                        hasDescendant(Matchers.not(withText("Test new")))
                    )
                )
            )
    }
